...
(function ($) {
	...
	SEMICOLON.initialize = {
		...
		responsiveClasses: function responsiveClasses() {
		...
		goToTopScroll: function goToTopScroll() {
		...
		commonHeight: function commonHeight(element) {
			var maxHeight = 0;
		...
		testimonialsGrid: function testimonialsGrid() {
		...
		blogTimelineEntries: function blogTimelineEntries() {
		...
		defineColumns: function defineColumns(element) {
			var column = 4,
			...
			if (element.hasClass('portfolio-full')) {
				...
				if (element.hasClass('grid-2')) column = 2;else if (element.hasClass('grid-3')) column = 3;else if (element.hasClass('grid-5')) column = 5;else if (element.hasClass('grid-6')) column = 6;else column = 4;
			}
		...
		setFullColumnWidth: function setFullColumnWidth(element) {
		...
		aspectResizer: function aspectResizer() {
		...
		dataResponsiveClasses: function dataResponsiveClasses() {
		...
		dataResponsiveHeights: function dataResponsiveHeights() {
	...
	SEMICOLON.header = {
		...
		menuInvert: function menuInvert() {
		...
		menufunctions: function menufunctions() {
			...
			if ($body.hasClass('device-xl') || $body.hasClass('device-lg')) {
				$('#primary-menu.sub-title > ul > li').hover(function () {
					...
					$(this).prev().css({ backgroundImage: 'url("../../../images/frontend/icons/menu-divider.png")' });
				});
		...
		fullWidthMenu: function fullWidthMenu() {
		...
		stickyMenu: function stickyMenu(headerOffset) {
		...
		stickyPageMenu: function stickyPageMenu(pageMenuOffset) {
		...
		sideHeader: function sideHeader() {
		...
		onePageScroll: function onePageScroll() {
		...
		onepageScroller: function onepageScroller() {
			$onePageMenuEl.find('li').removeClass('current');
			$onePageMenuEl.find('a[data-href="#' + SEMICOLON.header.onePageCurrentSection() + '"]').parent('li').addClass('current');
		},

		onePageCurrentSection: function onePageCurrentSection() {
		...
		stickyMenuClass: function stickyMenuClass() {
		...
		responsiveMenuClass: function responsiveMenuClass() {
	...
	SEMICOLON.slider = {
		...
		sliderParallaxDimensions: function sliderParallaxDimensions() {
		...
		sliderParallaxOffset: function sliderParallaxOffset() {
		...
		sliderElementsFade: function sliderElementsFade() {
		...
		captionPosition: function captionPosition() {
		...
		swiperSliderMenu: function swiperSliderMenu(onWinLoad) {
		...
		revolutionSliderMenu: function revolutionSliderMenu(onWinLoad) {
			onWinLoad = typeof onWinLoad !== 'undefined' ? onWinLoad : false;
			if ($body.hasClass('device-xl') || $body.hasClass('device-lg')) {
		...
		headerSchemeChanger: function headerSchemeChanger(activeSlide, onWinLoad) {
		...
		owlCaptionInit: function owlCaptionInit() {
	...
	SEMICOLON.portfolio = {
		...
		gridInit: function gridInit($container) {
		...
		filterInit: function filterInit() {
		...
		shuffleInit: function shuffleInit() {
		...
		portfolioDescMargin: function portfolioDescMargin() {
		...
		newNextPrev: function newNextPrev(portPostId) {
		...
		loadItem: function loadItem(portPostId, prevPostPortId, getIt) {
			if (!getIt) {
				getIt = false;
			}
			var portNext = SEMICOLON.portfolio.getNextItem(portPostId);
		...
		getNextItem: function getNextItem(portPostId) {
			var portNext = '';
		...
		getPrevItem: function getPrevItem(portPostId) {
			var portPrev = '';
		...
		initializeAjax: function initializeAjax(portPostId) {
	...
	SEMICOLON.widget = {
		...
		loadFlexSlider: function loadFlexSlider() {
		...
		youtubeBgVideo: function youtubeBgVideo() {
		...
		tabsJustify: function tabsJustify() {
		...
		tabsResponsive: function tabsResponsive() {
		...
		tabsResponsiveResize: function tabsResponsiveResize() {
		...
		runCounter: function runCounter(counterElement, counterElementComma) {
		...
		roundedSkill: function roundedSkill() {
		...
		runRoundedSkills: function runRoundedSkills(element, properties) {
		...
		flickrFeed: function flickrFeed() {
		...
		instagramPhotos: function instagramPhotos(c_accessToken, c_clientID) {
		...
		dribbbleShots: function dribbbleShots(c_accessToken) {
		...
		masonryThumbs: function masonryThumbs() {
		...
		masonryThumbsArrange: function masonryThumbsArrange(element) {
		...
		textRotater: function textRotater() {
		...
		linkScroll: function linkScroll() {
		...
		quickContact: function quickContact() {
		...
		cookieNotify: function cookieNotify() {
